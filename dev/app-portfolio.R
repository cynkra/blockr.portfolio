# Run the Portfolio Advisor board against LOCAL source checkouts (your latest
# uncommitted changes to any blockr package). This is the pkgload::load_all()
# counterpart of the shipped, library()-based inst/examples/app-portfolio.R:
# it just flips the loader and sources it, so the two can never drift.
#
# Run from an R session at the workspace root:
#   source("blockr.portfolio/dev/app-portfolio.R")
#
...
dev_local <- TRUE
source("blockr.portfolio/inst/examples/app-portfolio.R")
